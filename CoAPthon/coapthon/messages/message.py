...
class Message(object):
    ...
    @bearer.deleter
    def bearer(self):
        self.del_option_by_number(defines.OptionRegistry.BEARER.number)
    ...
    def token_type(self):
        ...
        value = None
        for option in self.options:
            if option.number == defines.OptionRegistry.TOKEN_TYPE.number:
                value = option.value
        return value
    ...
    def token_type(self, token_type):
        option = Option()
        option.number = defines.OptionRegistry.TOKEN_TYPE.number

        option.value = token_type
        self.add_option(option)

    @token_type.deleter
    def token_type(self):
        self.del_option_by_number(defines.OptionRegistry.TOKEN_TYPE.number)
    ...
    def scope(self, value):
        option = Option()
        option.number = defines.OptionRegistry.SCOPE.number
    ...
    @scope.deleter
    def scope(self):
        self.del_option_by_number(defines.OptionRegistry.SCOPE.number)