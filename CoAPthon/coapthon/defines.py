...
class OptionRegistry(object):
    ...
    # #message
    # TOKEN_TYPE = OptionItem(72, "Token_type", INTEGER, False, None)
    # #request
    # BEARER = OptionItem(71, "Bearer", OPAQUE, False, None)
    # TOKEN_TYPE_HINT = OptionItem(73, "Token_type_hint", INTEGER, False, None)
    # #response
    # ERROR = OptionItem(74, "Error", INTEGER, False, None)
    # ACTIVE = OptionItem(75, "Active", INTEGER, False, None)
