...
class ObservableResource(Resource):
    ...
    def update(self, first=False):
        ...
        # try:
        if "ed1bedae-a186-4301-a15f-20e466db95e9" not in self.introspection:
            self.introspection["ed1bedae-a186-4301-a15f-20e466db95e9"] = db["access_tokens"].find_one({"token": "ed1bedae-a186-4301-a15f-20e466db95e9"})
                # Resource.introspection["ed1bedae-a186-4301-a15f-20e466db95e9"] = db["access_tokens"].find_one({"token": "ed1bedae-a186-4301-a15f-20e466db95e9"})
